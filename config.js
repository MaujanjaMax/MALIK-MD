...
global.sudo = process.env.SUDO || '255788925545'
global.devs = '255788925545';
global.website = '' //wa.me/+255788925545
...
module.exports = {
  ...
  packname:  process.env.PACK_INFO === undefined ? 'pro Crs' : process.env.PACK_INFO.split(";")[1],
